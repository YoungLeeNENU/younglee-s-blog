...
from leemacs import LeemacsHandler as leemacs
from leeshell import LeeshellHandler as leeshell
from whoami import WhoamiHandler as whoami
from leemail import LeemailHandler as leemail
...
if __name__ == "__main__":
    ...
    app = tornado.web.Application(handlers = [(r"/", leemacs),
                                              (r"/leeshell", leeshell),
                                              (r"/leemail", leemail),
